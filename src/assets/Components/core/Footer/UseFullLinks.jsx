...
const UseFullLinks = () => {
  ...
  const useFullLinks = [
    ...
    { id: 2, text: "About", link: "/about", icon: <FaUser aria-hidden="true" /> },
    { id: 3, text: "Projects", link: "/projects", icon: <FaBriefcase aria-hidden="true" /> },
    { id: 4, text: "Blogs", link: "/blogs", icon: <FaBlog aria-hidden="true" /> },
    { id: 5, text: "Contact Us", link: "/contact-us", icon: <FaEnvelope aria-hidden="true" /> },
  ]
